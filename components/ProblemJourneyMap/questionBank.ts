...
export const BANK_QUESTIONS: BankQuestion[] = [
  ...
  },
  {
    ...
    text: "If the Problem is of Functional Type, what is a tangible size of the pain or gain? Example: 20mins wait time; $200 savings",
    answerType: "plain_text",
  },
  {
    id: "bq-7",
    category: "Problem Clarity",
    text: "If the Problem is of Emotional Type, what is a tangible size of the pain or gain? Example: 20mins wait time; $200 savings",
    answerType: "plain_text",
  },
  {
    id: "bq-8",
